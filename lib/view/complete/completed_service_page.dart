          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(captilaize(servicename) ?? "No Service Name",
                ...
                child: Column(children: [
                    ...
                    children: [
                      ...
                      Flexible(
                        child: Text(clientName ?? "No Client Name",
                            style: mainTextStyleBlack.copyWith(fontSize: 14)),
                      )
                    ],
                  ),
                  SizedBox(
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                          (startdate == null ? "Date Not Defined" : startdate) +
                              (starttime != null
                                  ? " ($starttime)"
                                  : "Time Not Defined"),
                          style: mainTextStyleBlack.copyWith(fontSize: 14))
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                          (enddate == null ? "Date Not Defined" : enddate) +
                              (endtime != null
                                  ? " ($endtime)"
                                  : "Time Not Defined"),
                          style: mainTextStyleBlack.copyWith(fontSize: 14))
                      ...
                      child: Column(children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(refNo ?? "No refno",
                                style:
                                    mainTextStyleBlack.copyWith(fontSize: 14))
                          ],
                        ),
                      ]),
                    ),
